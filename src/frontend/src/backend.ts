...
export class Backend implements backendInterface {
    ...
    async createForm(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createForm(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllForms(): Promise<Array<ContactFormData>> {
        if (this.processError) {
            try {
    ...
    async getAllFormsByEmail(): Promise<Array<ContactFormData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFormsByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
